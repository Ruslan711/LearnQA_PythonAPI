...
class TestUserAgent:
    ...
    def test_user_agent_check(self, user_agent, expected_platform, expected_browser, expected_device):
        ...
        actual_platform = response_json.get("platform")
        actual_browser = response_json.get("browser")
        actual_device = response_json.get("device")

        assert expected_platform == actual_platform
        assert expected_browser == actual_browser
